...
#imgLb1.grid(row = 1,column = 1,rowspan = 2)
...
def pick():
    ...
    label1.configure(text = nums[1])
    label1.configure(text = nums[2])
    label1.configure(text = nums[3])
    label1.configure(text = nums[4])
    label1.configure(text = nums[5])
